        ...
        <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <span class="text-xs text-gray-600">Address</span> <br>
                    <span class="text-xs text-gray-600">UK Non-geographic: Phone</span>  <br>
                    <span class="text-xs text-gray-600">UK London: Phone 2</span>  <br>
                    <span class="text-xs text-gray-600">UK Mobile: phone 3</span>  <br>
                </div>
            </div>
        </div>
